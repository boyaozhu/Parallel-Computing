...
__global__ void simulateKernel (double* E,  double* E_prev,double* R,
	       ...
	       const double M1,const double  M2, const double b)
{
    ...
    simulateKernel<<<DimGrid, DimBlock, sizeof(double)*(blocksize+2)*(blocksize+2)>>>(E, E_prev, R, alpha, n, m, kk, dt, a, epsilon, M1, M2, b);
